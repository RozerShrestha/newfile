...
public class Rentees {
    ...
    private int renteeImmidateContactPhno;
    private String renteeInformation;

    public Rentees() {
    }

    public Rentees(int renteeId, String renteeName, String parmanentAddress, int phoneNo, String email, String rentDate, boolean status, String renteeImmidateContactName, int renteeImmidateContactPhno, String renteeInformation) {
    ...
    public int getRenteeImmidateContactPhno() {
    ...
    public void setRenteeImmidateContactPhno(int renteeImmidateContactPhno) {
        this.renteeImmidateContactPhno = renteeImmidateContactPhno;
    }
